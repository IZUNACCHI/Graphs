...
namespace NarrativeTool.Canvas.Views
{
    ...
    public sealed class EdgeLayer : VisualElement
    {
        ...
        public void Bind(GraphData graph, Dictionary<string, NodeView> nodeViews)
        {
            this.graph = graph;
        ...
        public void RefreshEdgesForNode(string nodeId)
        {
            if (graph == null) return;
        ...
        private GraphView FindCanvas()
        {
            VisualElement ve = this;
            while (ve != null) { if (ve is GraphView gc) return gc; ve = ve.parent; }
            return null;
        }
