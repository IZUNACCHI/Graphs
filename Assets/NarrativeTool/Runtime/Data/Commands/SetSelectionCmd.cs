...
namespace NarrativeTool.Core
{
    ...
    /// sets; Do applies 'after', Undo applies 'before'.
    ///
    /// Does not merge — each selection change produces its own undo entry.
    /// A future marquee-select flow may want to merge; that's a TODO.
    /// </summary>
